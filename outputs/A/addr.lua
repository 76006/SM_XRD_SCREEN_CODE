...
Timer_Info = {
    ...
    [Timer_ID.RF_Start] = {ID = Timer_ID.RF_Start, timeout = 10000, countdown =1 , timesrepeat = 5,curtimesrepeat = 0},
    [Timer_ID.Verify_Gear_RF_Timer] = {ID = Timer_ID.Verify_Gear_RF_Timer, timeout = 10000, countdown =1 , timesrepeat = 5,curtimesrepeat = 0},
...
ERROR_ADDR={
    ...
    -- 冷媒相关错误
    ErrorCoolantInsufficient   = 0x0018,  -- 冷媒不足: 更换冷媒剂或者重试
    ErrorCoolantInsufficient2  = 0x0058,  -- 冷媒不足: 若多次连续出现，请更换冷媒剂
    ErrorCoolantInsufficient3  = 0x0113,  -- 冷媒不足: 请更换冷媒剂
    ErrorNoCoolantBottle       = 0x0114,  -- 没有冷媒瓶: 请放置冷媒瓶
    ErrorCoolantPreheating     = 0x0112,  -- 冷媒预热中: 请稍等

    -- 内部错误系列 (0x0020-0x0032)
    ...
    ErrorInternal0030          = 0x0030,  -- 内部错误: 请联系售后
    ErrorInternal0031          = 0x0031,  -- 内部错误: 请联系售后
    ErrorInternal0032          = 0x0032,  -- 内部错误: 请联系售后
    ...
    -- 内部错误系列 (0x0040-0x0053)
    ErrorInternal0040          = 0x0040,  -- 内部错误: 请联系售后
    ErrorInternal0042          = 0x0042,  -- 内部错误: 请联系售后
    ErrorInternal0043          = 0x0043,  -- 内部错误: 请联系售后
    ...
    -- 内部错误系列 (0x0060-0x007D)
    ErrorInternal0060          = 0x0060,  -- 内部错误: 请联系售后
    ErrorInternal0061          = 0x0061,  -- 内部错误: 请联系售后
    ErrorInternal0062          = 0x0062,  -- 内部错误: 请联系售后
    ErrorInternal0063          = 0x0063,  -- 内部错误: 请联系售后

    -- 治疗接触相关错误
    ErrorPoorContact           = 0x0070,  -- 治疗时可能未良好接触: 若多次重试后失败，请联系售后
    ErrorPoorContact2          = 0x0072,  -- 治疗时可能未良好接触: 若多次重试后失败，请联系售后
    ErrorPoorContact3          = 0x0074,  -- 治疗时可能未良好接触: 若多次重试后失败，请联系售后

    -- 治疗头相关错误
    ErrorHandpieceError        = 0x0080,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceTimeout      = 0x0081,  -- 治疗头超时: 更换有效的治疗头
    ErrorHandpieceError2       = 0x0082,  -- 治疗头错误: 重新插拔治疗头
    ErrorHandpieceInvalid      = 0x0083,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceNotInserted  = 0x0084,  -- 治疗头没插好: 请重新插治疗头
    ErrorHandpieceOverheat     = 0x0085,  -- 治疗头过温: 
    ErrorHeadContactAbnormal   = 0x0086,  -- 头端接触异常: 请重新插拔
    ErrorHandpieceError3       = 0x0089,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceError4       = 0x008A,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceError5       = 0x008B,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceError6       = 0x008C,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceError7       = 0x008D,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceError8       = 0x008E,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceError9       = 0x008F,  -- 治疗头错误: 更换有效的治疗头
    ErrorHandpieceInvalid2     = 0x0091,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceInvalid3     = 0x0092,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceInvalid4     = 0x0093,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceInvalid5     = 0x0094,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceInvalid6     = 0x0095,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceInvalid7     = 0x009B,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceInvalid8     = 0x009C,  -- 治疗头无效: 更换有效的治疗头
    ErrorHandpieceExhausted    = 0x009E,  -- 治疗头次数耗尽: 更换有效的治疗头
    ErrorHandpieceInvalid9     = 0x009F,  -- 治疗头无效: 更换有效的治疗头

    -- 内部错误系列 (0x00A1-0x00B0)
    ErrorInternal00A1          = 0x00A1,  -- 内部错误: 请联系售后
    ErrorInternal00A2          = 0x00A2,  -- 内部错误: 请联系售后
    ErrorInternal00A3          = 0x00A3,  -- 内部错误: 请联系售后
    ErrorInternal00A4          = 0x00A4,  -- 内部错误: 请联系售后
    ErrorInternal00AA          = 0x00AA,  -- 内部错误: 请联系售后
    ErrorInternal00AB          = 0x00AB,  -- 内部错误: 请联系售后
    ErrorInternal00AC          = 0x00AC,  -- 内部错误: 请联系售后
    ErrorInternal00B0          = 0x00B0,  -- 内部错误: 请联系售后

    -- 内部错误系列 (0x0100-0x0119)
    ErrorInternal0100          = 0x0100,  -- 内部错误: 请联系售后
    ErrorInternal0101          = 0x0101,  -- 内部错误: 请联系售后
    ErrorInternal0102          = 0x0102,  -- 内部错误: 请联系售后
    ErrorInternal0106          = 0x0106,  -- 内部错误: 请联系售后
    ErrorInternal0110          = 0x0110,  -- 内部错误: 请联系售后
    ErrorInternal0115          = 0x0115,  -- 内部错误: 请联系售后
    ErrorInternal0118          = 0x0118,  -- 内部错误: 请联系售后

    -- 操作相关错误
    ErrorEmissionKeyPressedTooLong = 0x0108,  -- 发射键按压时间过长: 请松开后重试
    ...
    -- 负极板错误
    ErrorNegativePlateDisconnected = 0x0111,  -- 负极板未连接: 请连接好负极板
    ...
    -- 内部错误系列 (0x0130-0x1052)
    ErrorInternal0130          = 0x0130,  -- 内部错误: 请联系售后
    ErrorInternal0131          = 0x0131,  -- 内部错误: 请联系售后
    ErrorInternal1010          = 0x1010,  -- 内部错误: 请联系售后
    ErrorInternal1050          = 0x1050,  -- 内部错误: 请联系售后
    ErrorInternal1051          = 0x1051,  -- 内部错误: 请联系售后
    ErrorInternal1052          = 0x1052,  -- 内部错误: 请联系售后


    Error_File_MCU_ERROR                    =0x40,  --  上传文件时下位机错误
    Error_File_Screen_ERROR                 =0x201,  --  上传文件时上位机错误
    Error_File_Send_MCU_ERROR               =0x41,  --  下载文件时下位机错误
    Error_File_Send_Screen_ERROR           =0x203,  --  下载文件时上位机错误
...
ErrorMessages = {
    ...
    -- 冷媒相关错误
    [ERROR_ADDR.ErrorCoolantInsufficient] = {title = "冷媒不足", solution = "更换冷媒剂或者重试", type = "coolant", level = "error"},
    [ERROR_ADDR.ErrorCoolantInsufficient2] = {title = "冷媒不足", solution = "若多次连续出现，请更换冷媒剂", type = "coolant", level = "error"},
    [ERROR_ADDR.ErrorCoolantInsufficient3] = {title = "冷媒不足", solution = "请更换冷媒剂", type = "coolant", level = "error"},
    [ERROR_ADDR.ErrorNoCoolantBottle] = {title = "没有冷媒瓶", solution = "请放置冷媒瓶", type = "coolant", level = "error"},
    ...
    [ERROR_ADDR.ErrorInternal0030] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0031] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0032] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    ...
    -- 内部错误系列 (0x0040-0x0053)
    [ERROR_ADDR.ErrorInternal0040] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0042] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0043] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    ...
    -- 内部错误系列 (0x0060-0x007D)
    [ERROR_ADDR.ErrorInternal0060] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0061] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0062] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0063] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    
    -- 治疗接触相关错误
    [ERROR_ADDR.ErrorPoorContact] = {title = "治疗时可能未良好接触", solution = "若多次重试后失败，请联系售后", type = "treatment", level = "warning"},
    [ERROR_ADDR.ErrorPoorContact2] = {title = "治疗时可能未良好接触", solution = "若多次重试后失败，请联系售后", type = "treatment", level = "warning"},
    [ERROR_ADDR.ErrorPoorContact3] = {title = "治疗时可能未良好接触", solution = "若多次重试后失败，请联系售后", type = "treatment", level = "warning"},
    ...
    [ERROR_ADDR.ErrorHandpieceError2] = {title = "治疗头错误", solution = "重新插拔治疗头", type = "handpiece", level = "error"},
    ...
    [ERROR_ADDR.ErrorHandpieceOverheat] = {title = "治疗头过温", solution = "", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHeadContactAbnormal] = {title = "头端接触异常", solution = "请重新插拔", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError3] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError4] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError5] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError6] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError7] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError8] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceError9] = {title = "治疗头错误", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid2] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid3] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid4] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid5] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid6] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid7] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid8] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceExhausted] = {title = "治疗头次数耗尽", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    [ERROR_ADDR.ErrorHandpieceInvalid9] = {title = "治疗头无效", solution = "更换有效的治疗头", type = "handpiece", level = "error"},
    
    -- 内部错误系列 (0x00A1-0x00B0)
    [ERROR_ADDR.ErrorInternal00A1] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00A2] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00A3] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00A4] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00AA] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00AB] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00AC] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal00B0] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    
    -- 内部错误系列 (0x0100-0x0119)
    [ERROR_ADDR.ErrorInternal0100] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0101] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0102] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0106] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0110] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0115] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0118] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    
    -- 操作相关错误
    [ERROR_ADDR.ErrorEmissionKeyPressedTooLong] = {title = "发射键按压时间过长", solution = "请松开后重试", type = "operation", level = "warning"},
    ...
    -- 负极板错误
    [ERROR_ADDR.ErrorNegativePlateDisconnected] = {title = "负极板未连接", solution = "请连接好负极板", type = "accessory", level = "error"},
    ...
    -- 内部错误系列 (0x0130-0x1052)
    [ERROR_ADDR.ErrorInternal0130] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal0131] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal1010] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal1050] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal1051] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},
    [ERROR_ADDR.ErrorInternal1052] = {title = "内部错误", solution = "请联系售后", type = "internal", level = "error"},

    [ERROR_ADDR.Error_File_MCU_ERROR] = {title = "上传文件时下位机错误", solution = "请重试", type = "internal", level = "error"},
    [ERROR_ADDR.Error_File_Screen_ERROR] = {title = "上传文件时上位机错误", solution = "请重试", type = "internal", level = "error"},
    [ERROR_ADDR.Error_File_Send_MCU_ERROR] = {title = "下载文件时下位机错误", solution = "请重试", type = "internal", level = "error"},
    [ERROR_ADDR.Error_File_Send_Screen_ERROR] = {title = "下载文件时上位机错误", solution = "请重试", type = "internal", level = "error"},
...
var_read_map = {
    ...
    [VAR_ADDR.UsedTotalShots] = function(data)
        ...
        set_text(SCREENID.Treatment_Not_Recognized_SCREEN,Treatment_Not_Recognized_SCREEN_CONTROL.Pulse_Count,total_count)
...
function screen_write_to_MCU(addr, value,len)
    ...
    if addr ~= nil then
        ...
        set_text(SCREENID.Treatment_Process_SCREEN,9 ,addr)
    end
    if value ~= nil then
        
        set_text(SCREENID.Treatment_Process_SCREEN,10 ,value)
    end
