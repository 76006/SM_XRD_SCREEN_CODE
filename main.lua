...
function on_control_notify(screen, control, value)
    ...
    elseif screen == SCREENID.Power_Debugging_Interface_SCREEN then
        ...
        elseif control == Power_Debugging_Interface_CONTROL.test_start and value == Trigger then
            ...
            Current_Power_Debuginfo.voltage_num =0
             Current_Power_Debuginfo.voltage = {}
    ...
    elseif screen == SCREENID.Power_Verify_SCREEN then
            ...
            elseif control == Power_Verify_Interface_CONTROL.retest  and value == Trigger then
                ...
                if Current_info.Verify_Rf_Test_Flag == 0 and Current_info.Retest_Select_Test_Flag ==0  then
                    ...
                    print("Current_info.Retest_Select"..Current_info.Retest_Select)
                    if Current_info.Retest_Select>=0 then
                        ...
                        print("Current_info.Retest_Select_Geer"..Current_info.Retest_Select_Geer)
                        start_timer(Timer_ID.Verify_Gear_RF_Timer,Timer_Info[Timer_ID.Verify_Gear_RF_Timer].timeout,Timer_Info[Timer_ID.Verify_Gear_RF_Timer].countdown,Timer_Info[Timer_ID.Verify_Gear_RF_Timer].timesrepeat)
                        Power_verify_screen_control_enable(0)
            ...
            elseif control == Power_Verify_Interface_CONTROL.shengmei_flag_button  then
                set_value(SCREENID.Power_Verify_SCREEN, Power_Verify_Interface_CONTROL.yimei_flag_button,1-value)
            elseif control == Power_Verify_Interface_CONTROL.yimei_flag_button  then
                set_value(SCREENID.Power_Verify_SCREEN, Power_Verify_Interface_CONTROL.shengmei_flag_button,1-value)
                
            end
    elseif screen == SCREENID.BodyTreatment_Process_SCREEN then
        if DEBUGFLAG == 1 then
            print("Current_info.Cold:" .. Current_info.Cold)
            print("Current_info.Gear:" .. Current_info.Gear)
        end

        if control == BODYTreatment_Process_SCREEN_CONTROL.Sub_Button and value == Trigger then
            if Current_info.Gear <= 0 then
                return
            else
                Current_info.Gear = Current_info.Gear - 0.5
            ...
            -- screen_write_to_MCU(VAR_ADDR.CoolLevel,Current_info.Cold,1);
            screen_write_to_MCU(VAR_ADDR.PowerLevel,Current_info.Gear*10);
        elseif control == BODYTreatment_Process_SCREEN_CONTROL.Add_Button and value == Trigger then
        ...
        elseif control == BODYTreatment_Process_SCREEN_CONTROL.Cold_Button and value == Trigger then

            -- screen_write_to_MCU(VAR_ADDR.CoolLevel,Current_info.Cold,1);

        elseif control == BODYTreatment_Process_SCREEN_CONTROL.Vibration_Button  then

            Current_info.Vibration = value
            set_value(SCREENID.BodyTreatment_Process_SCREEN, BODYTreatment_Process_SCREEN_CONTROL.Vibration_Icon, value)
            print("Current_info.Vibration="..Current_info.Vibration)
            screen_write_to_MCU(VAR_ADDR.VibrateBtn,Current_info.Vibration);
    ...
    elseif screen == SCREENID.V2Treatment_Process_SCREEN then
            if DEBUGFLAG == 1 then
            print("Current_info.Cold:" .. Current_info.Cold)
            print("Current_info.Gear:" .. Current_info.Gear)
        end
        if control == V2Treatment_Process_SCREEN_CONTROL.Classic_Mode_Button and value == Press then
            set_value(SCREENID.V2Treatment_Process_SCREEN, V2Treatment_Process_SCREEN_CONTROL.Comfort_Mode_Button, Bounce)
            screen_write_to_MCU(VAR_ADDR.ModeCtrl,Treat_mode.Classic_Mode);
        elseif control == V2Treatment_Process_SCREEN_CONTROL.Comfort_Mode_Button and value == Press then
            set_value(SCREENID.V2Treatment_Process_SCREEN, V2Treatment_Process_SCREEN_CONTROL.Classic_Mode_Button, Bounce)
            screen_write_to_MCU(VAR_ADDR.ModeCtrl,Treat_mode.Comfort_Mode);
        elseif control == V2Treatment_Process_SCREEN_CONTROL.Sub_Button and value == Trigger then
            if Current_info.Gear <= 0 then
                return
            else
                Current_info.Gear = Current_info.Gear - 0.5
            ...
            -- screen_write_to_MCU(VAR_ADDR.CoolLevel,Current_info.Cold,1);
            screen_write_to_MCU(VAR_ADDR.PowerLevel,Current_info.Gear*10);
        elseif control == V2Treatment_Process_SCREEN_CONTROL.Add_Button and value == Trigger then
        ...
        elseif control == V2Treatment_Process_SCREEN_CONTROL.Cold_Button and value == Trigger then

            -- screen_write_to_MCU(VAR_ADDR.CoolLevel,Current_info.Cold,1);

        elseif control == V2Treatment_Process_SCREEN_CONTROL.Vibration_Button  then

            Current_info.Vibration = value
            set_value(SCREENID.V2Treatment_Process_SCREEN, V2Treatment_Process_SCREEN_CONTROL.Vibration_Icon, value)
            print("Current_info.Vibration="..Current_info.Vibration)
            screen_write_to_MCU(VAR_ADDR.VibrateBtn,Current_info.Vibration);
